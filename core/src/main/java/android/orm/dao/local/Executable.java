...
public interface Executable<V> {
    ...
    interface Exists extends android.orm.DAO.Access.Exists<Executable<Boolean>> {
    }

    final class Query {

        public static class Single<V> extends Builder<V> {
            ...
            @NonNull
            @Override
            protected final DAO.Query.Builder<V> query(@NonNull final DAO dao) {
                return dao.at(mRoute, mArguments).query(mReading);
            }
        }

        public static class Many<V> extends Builder<V> {
        ...
        public static class Aggregate<V> extends Builder<V> {
        ...
        public abstract static class Builder<V> implements android.orm.DAO.Access.Query.Builder<V, Executable<V>> {
            ...
            @NonNull
            protected abstract DAO.Query.Builder<V> query(@NonNull final DAO dao);

            @NonNull
            @Override
            public final Builder<V> with(@Nullable final Select.Where where) {
            ...
            @NonNull
            @Override
            public final Builder<V> with(@Nullable final Select.Order order) {
                mOrder = order;
                return this;
            }

            @NonNull
            public final Builder<V> with(@Nullable final Select.Limit limit) {
                mLimit = limit;
                return this;
            }

            @NonNull
            public final Builder<V> with(@Nullable final Select.Offset offset) {
                mOffset = offset;
                return this;
            }
    ...
    interface Insert extends android.orm.DAO.Access.Insert<Executable<Uri>> {
    }

    interface Update extends android.orm.DAO.Access.Update<Executable<Integer>> {
    }

    interface Delete extends android.orm.DAO.Access.Delete<Executable<Integer>> {
    }

    interface Write extends Insert, Update, Delete, android.orm.DAO.Access.Write<Executable<Uri>, Executable<Integer>, Executable<Integer>> {
        abstract class Base extends android.orm.DAO.Access.Write.Base<Executable<Uri>, Executable<Integer>, Executable<Integer>> implements Write {
            protected Base() {
                super();
            }
        }
    ...
    final class Access {
        ...
        public static class Some implements Exists, Write {
            ...
            public Some(@NonNull final Route route, @NonNull final Object... arguments) {
                super();
