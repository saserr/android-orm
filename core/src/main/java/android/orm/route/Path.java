...
public class Path {
    ...
    @NonNull
    private final Select.Where.Builder<?>[] mWhere;
    ...
    private Path(@NonNull final List<Segment> segments,
                 ...
                 @NonNull final Select.Where.Builder<?>... where) {
        super();
    ...
    public final Path slash(@NonNull final Segment segment) {
        ...
        final Select.Where.Builder<?>[] where;
        ...
        if (segment instanceof Segment.Argument) {
            ...
            where = new Select.Where.Builder<?>[mWhere.length + 1];
