...
public class Apply implements Function<Pair<String, Collection<Producer<ContentProviderOperation>>>, Maybe<Transaction.CommitResult>> {
    ...
    @NonNull
    @Override
    public final Maybe<Transaction.CommitResult> invoke(@NonNull final Pair<String, Collection<Producer<ContentProviderOperation>>> pair) {
